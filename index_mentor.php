...
/**
 * Copy of the index.php file
 * Mentor permission are checked instead of standard permissions
 *
 * @package    tool
...
$managedentities = \local_mentor_core\entity_api::get_managed_entities(null, false);

if (count($managedentities) === 0) {
    throw new \moodle_exception('Permission denied');
}

$url = new moodle_url('/admin/tool/mergeusers/index_mentor.php');
$PAGE->set_url($url);
